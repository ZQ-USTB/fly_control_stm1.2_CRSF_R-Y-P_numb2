...
#define MAX_FRAME_SIZE 36 // Maximum frame length for idle interrupt reception

/**
 * CRSF Protocol Type Definitions
 */
...
/**
 * CRSF Protocol Address Definitions
 */
...
/**
 * @brief ELRS/CRSF Data Structure
 */
typedef struct
{
    // RC Channel Data (11-bit)
